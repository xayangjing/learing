...
for blade in query_data['ComputeBlade']:
    ...
    blade_parent_chindren = handle.query_children(in_dn=blade_parent_info.dn, class_id="EquipmentIOCard")
    ...
    blade_info_chindren = handle.query_children(in_mo=blade_info, class_id="adaptorUnit")
